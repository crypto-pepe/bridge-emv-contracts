...
describe("Multisig", () => {
  ...
  describe("should be initialized", () => {
    it("should throw when empty owners array", async () => {
      ...
      return expect(
        Multisig.deploy([""], 1, MULTISIG_TTL_DEFAULT)
    ...
    it("should throw when quorum == 0", async () => {
      ...
      return expect(
        Multisig.deploy([owner.address], 0, MULTISIG_TTL_DEFAULT)
    ...
    it("should throw when quorum more than owners length", async () => {
      ...
      return expect(
        Multisig.deploy([owner.address, other.address], 3, MULTISIG_TTL_DEFAULT)
      ).be.rejectedWith("invalid quorum");
    });
    ...
    it("should throw when owner array contains zero address", async () => {
      ...
      return expect(
        Multisig.deploy([owner.address, ZERO_ADDRESS], 1, MULTISIG_TTL_DEFAULT)
      ).be.rejectedWith("invalid quorum");
    });
